...
[![CRAN RStudio mirror downloads](https://cranlogs.r-pkg.org/badges/grand-total/UniprotR?color=blue)](https://r-pkg.org/pkg/UniprotR) [![](https://www.r-pkg.org/badges/version/UniprotR?color=green)](https://cran.r-project.org/package=UniprtoR) [![Build Status](https://travis-ci.com/AliYoussef96/UniprotR.svg?branch=master)](https://travis-ci.com/AliYoussef96/UniprotR)
